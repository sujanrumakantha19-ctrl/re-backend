...
const seed = async () => {
  ...
  const leadData = [
    ...
    { customerName: 'Sunita Verma', phone: '+91 98765 99012', email: 'sunita.v@gmail.com', city: 'Hyderabad', status: 'Customer', sourceType: 'Channel Partner', source: 'CP Realty', assignedTo: staff._id, assignedToName: 'Staff User', dateAdded: '2025-04-15', projectId: projects[0]._id, paymentStatus: 'Fully Paid', dob: '1986-07-09' },
    { customerName: 'Prakash Raj', phone: '+91 98765 99013', email: 'prakash.r@yahoo.com', city: 'Bengaluru', status: 'Customer', sourceType: 'Staff', source: 'Staff User', assignedTo: staff._id, assignedToName: 'Staff User', dateAdded: '2025-03-20', projectId: projects[1]._id, paymentStatus: 'Fully Paid', dob: '1981-12-19' },
    { customerName: 'Anjali Kapoor', phone: '+91 98765 99014', email: 'anjali.k@outlook.com', city: 'Chennai', status: 'Customer', sourceType: 'Direct', source: 'Walk-In', assignedTo: staff._id, assignedToName: 'Staff User', dateAdded: '2025-04-02', projectId: projects[2]._id, paymentStatus: 'Partially Paid', dob: '1990-05-14' },
    { customerName: 'Ravi Teja', phone: '+91 98765 99015', email: 'ravi.t@gmail.com', city: 'Hyderabad', status: 'Customer', sourceType: 'Channel Partner', source: 'CP Realty', assignedTo: staff._id, assignedToName: 'Staff User', dateAdded: '2025-02-28', projectId: projects[0]._id, paymentStatus: 'Fully Paid', dob: '1983-10-01' },
    { customerName: 'Geeta Shenoy', phone: '+91 98765 99016', email: 'geeta.s@yahoo.com', city: 'Pune', status: 'Customer', sourceType: 'Staff', source: 'Staff User', assignedTo: staff._id, assignedToName: 'Staff User', dateAdded: '2025-05-05', projectId: projects[3]._id, paymentStatus: 'Fully Paid', dob: '1988-09-12' },
    { customerName: 'Vikram Singh', phone: '+91 98765 99017', email: 'vikram.singh@gmail.com', city: 'Mumbai', status: 'Customer', sourceType: 'Direct', source: 'Website', assignedTo: staff._id, assignedToName: 'Staff User', dateAdded: '2025-01-15', projectId: projects[1]._id, paymentStatus: 'Partially Paid', dob: '1978-06-25' },
    { customerName: 'Radhika Iyengar', phone: '+91 98765 99018', email: 'radhika.i@gmail.com', city: 'Bengaluru', status: 'Customer', sourceType: 'Channel Partner', source: 'CP Realty', assignedTo: staff._id, assignedToName: 'Staff User', dateAdded: '2025-04-28', projectId: projects[1]._id, paymentStatus: 'Fully Paid', dob: '1991-11-30' },
    { customerName: 'Srinivas Murthy', phone: '+91 98765 99019', email: 'srinivas.m@outlook.com', city: 'Hyderabad', status: 'Customer', sourceType: 'Direct', source: 'Walk-In', assignedTo: staff._id, assignedToName: 'Staff User', dateAdded: '2025-03-10', projectId: projects[0]._id, paymentStatus: 'Fully Paid', dob: '1985-02-14' },
    { customerName: 'Pooja Deshmukh', phone: '+91 98765 99020', email: 'pooja.d@gmail.com', city: 'Pune', status: 'Customer', sourceType: 'Staff', source: 'Staff User', assignedTo: staff._id, assignedToName: 'Staff User', dateAdded: '2025-05-22', projectId: projects[3]._id, paymentStatus: 'Partially Paid', dob: '1994-08-07' }
  ];
